...
describe("coordination engine migration", () => {
  ...
  it("keeps 0034 metadata free of removed mobile identity tables", () => {
    const sql = readFileSync(
      resolve(process.cwd(), "drizzle/0034_coordination_engines.sql"),
      "utf8",
    )
    const snapshot = readFileSync(resolve(process.cwd(), "drizzle/meta/0034_snapshot.json"), "utf8")
