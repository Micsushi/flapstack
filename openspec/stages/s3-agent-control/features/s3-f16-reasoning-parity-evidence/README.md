...
- Migrated authority: former Stage 2 tasks `5.8` and `5.8h`.
- Dependencies: S3-F15 provider harness closeout, S3-F10 secure credentials,
  and dev-test-control MCP closeout.
- Blocks: S3-F17 integrated regression and release.
