# S5-F5 — Visual Context and Screenshot Capture

### S5-F5-T1 — Lock capture sources, privacy, retention, and agent authority

- [ ] Completion: acceptance and verification passed
- Parent: Project Flapstack / Stage S5 / Feature S5-F5
...
- Blocked by: accepted Stage 4 attachments/knowledge/workspaces
- Blocks: S5-F5-T2, S5-F5-T3, S5-F5-T4, S5-F5-T5, S5-F5-T6, S5-F5-T7
- Context: Electron desktopCapturer, permissions, attachments, audit.

### S5-F5-T2 — Implement platform-aware screen/window/region capture
...
- Blocked by: S5-F5-T1
- Blocks: S5-F5-T3, S5-F5-T8
- Context: Electron capture APIs, platform permission diagnostics.

### S5-F5-T3 — Build preview, crop, annotation, and irreversible redaction
...
- Blocked by: S5-F1-T2, S5-F5-T1, S5-F5-T2
- Blocks: S5-F5-T4, S5-F5-T5, S5-F5-T6, S5-F5-T7
- Context: image attachment preview, canvas/editor primitives.

### S5-F5-T4 — Integrate visual artifacts with chats, tasks, knowledge, and runs
...
- Blocked by: S5-F5-T1, S5-F5-T3
- Blocks: S5-F5-T5, S5-F5-T6, S5-F5-T7, S5-F5-T8
- Context: attachments, artifacts, project vault, launch context.

### S5-F5-T5 — Add approval-gated agent visual-context operations
...
- Blocked by: S5-F5-T1, S5-F5-T3, S5-F5-T4
- Blocks: S5-F5-T8
- Context: app-control MCP, questions/approvals, attachment tools.

### S5-F5-T6 — Add visual history, retention, cleanup, and export
...
- Blocked by: S5-F5-T3, S5-F5-T4
- Blocks: S5-F5-T7, S5-F5-T8
- Context: portability registry, artifact references, database maintenance.

### S5-F5-T7 — Extract the optional standalone capture helper
...
- Blocked by: S5-F5-T3, S5-F5-T4, S5-F5-T6, S5-F10-T1
- Blocks: S5-F5-T8
- Context: shared capture service, protocol/deep-link, package config.

### S5-F5-T8 — Close visual-context acceptance
...
- Scope: Matrix S5-VC; real OS capture; multiple displays; accessibility; secrets/redaction; context truth; package/helper; docs; recovery.
...
- Blocked by: S5-F5-T2, S5-F5-T4, S5-F5-T5, S5-F5-T6, S5-F5-T7
