...
Flapstack SHALL bind every required Stage 6 acceptance row to one exact source
...
### Requirement: Clean and Stage 5 upgrade integrity

Flapstack SHALL preserve supported Stage 5 data/authority/history while clean
install and upgrade reach the complete Stage 6 product.

#### Scenario: Upgrade encounters legacy inline personality

- **WHEN** Stage 6 opens it
- **THEN** history remains readable and conversion is explicit/non-destructive

### Requirement: Integrated Stage 6 workflow
