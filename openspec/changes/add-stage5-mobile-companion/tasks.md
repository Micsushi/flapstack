# S5-F4 — Cross-Agent Mobile Companion

### S5-F4-T1 — Reconcile preserved mobile work and refresh the threat model

- [ ] Completion: acceptance and verification passed
- Parent: Project Flapstack / Stage S5 / Feature S5-F4
...
- Blocks: S5-F4-T2, S5-F4-T3, S5-F4-T4, S5-F4-T6
- Context: preserved add-mobile-control-companion change and mobile code/tests.

### S5-F4-T2 — Integrate the default-off HTTPS bridge lifecycle
...
- Blocked by: S5-F4-T1
- Blocks: S5-F4-T3, S5-F4-T4, S5-F4-T8
- Context: preserved mobile-bridge, app shutdown, secure storage.

### S5-F4-T3 — Integrate pairing, device identity, sessions, and revocation
...
- Blocked by: S5-F4-T1, S5-F4-T2
- Blocks: S5-F4-T4, S5-F4-T5, S5-F4-T6, S5-F4-T7, S5-F4-T8
- Context: preserved mobile-pairing, WebAuthn, audit.

### S5-F4-T4 — Integrate sequenced snapshots, events, scopes, and reconnect
...
- Blocked by: S5-F4-T1, S5-F4-T2, S5-F4-T3, S5-F7-T5
- Blocks: S5-F4-T5, S5-F4-T6, S5-F4-T7, S5-F4-T8
- Context: product invalidation, F3/F11 activity, automation, approvals.

### S5-F4-T5 — Build the polished responsive companion PWA
...
- Blocked by: S5-F1-T3, S5-F4-T3, S5-F4-T4
- Blocks: S5-F4-T6, S5-F4-T7, S5-F4-T8
- Context: Stage 5 UI primitives, preserved PWA concepts, mobile layouts.

### S5-F4-T6 — Add bounded steering and lifecycle actions
...
- Blocked by: S5-F4-T1, S5-F4-T3, S5-F4-T4, S5-F4-T5, S5-F7-T4
- Blocks: S5-F4-T7, S5-F4-T8
- Context: question lifecycle, cascade control, automation control.

### S5-F4-T7 — Add mobile approvals and honest notifications
...
- Blocked by: S5-F4-T3, S5-F4-T4, S5-F4-T5, S5-F4-T6
- Blocks: S5-F4-T8
- Context: approval coordinator, notification/inbox patterns.

### S5-F4-T8 — Close real-device mobile acceptance

- [ ] Completion: acceptance and verification passed
- Parent: Project Flapstack / Stage S5 / Feature S5-F4
- Outcome: Pairing, monitoring, steering, approval, revoke, offline, and reconnect pass real-device evidence.
- Scope: Matrix S5-MC; private/public network; iOS/Android-class browsers; QR/fingerprint; lifecycle; diff/artifact; offline/reconnect; revoke; security review; docs/package.
...
- Blocked by: S5-F4-T2, S5-F4-T3, S5-F4-T4, S5-F4-T5, S5-F4-T6, S5-F4-T7, S5-F7-T7
- Blocks: S5-F11-T3, S5-F11-T4, S5-F11-T5
