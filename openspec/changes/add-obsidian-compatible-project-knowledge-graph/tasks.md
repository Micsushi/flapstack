# S5-F12 — Obsidian-Compatible Project Knowledge Graph

### S5-F12-T1 — Migrate typed sections into stable seed-note identities

- [ ] Completion: acceptance and verification passed
- Parent: Project Flapstack / Stage S5 / Feature S5-F12
...
- Blocked by: fully accepted S4-F2 and Stage 4 exact SHA
- Blocks: S5-F12-T2, S5-F12-T3, S5-F12-T5, S5-F12-T7, S5-F12-T8
- Context: `projectVaults`, `projectVaultSections`, storage backups, registry, filesystem-root identity, Stage 4 export fixtures.

### S5-F12-T2 — Enforce Obsidian-open and Git-safe vault location behavior
...
- Blocked by: S5-F12-T1
- Blocks: S5-F12-T4, S5-F12-T5, S5-F12-T8
- Context: project-vault policy, Git path resolution/security, Electron shell integration, portability location mapping.

### S5-F12-T3 — Parse and resolve the supported Obsidian Markdown subset
...
- Blocked by: S5-F12-T1
- Blocks: S5-F12-T4, S5-F12-T5, S5-F12-T6, S5-F12-T7
- Context: Markdown renderer, project-vault content safety, path safety, Obsidian internal-link and property contracts.

### S5-F12-T4 — Build the rebuildable graph index and external-change watcher
...
- Blocked by: S5-F12-T2, S5-F12-T3
- Blocks: S5-F12-T5, S5-F12-T6, S5-F12-T7, S5-F12-T8
- Context: project-vault storage/browser, tRPC invalidation, filesystem-root registration, portability journals.

### S5-F12-T5 — Add custom-note, folder, attachment, and conflict workflows
...
- Blocked by: S5-F12-T1, S5-F12-T2, S5-F12-T3, S5-F12-T4
- Blocks: S5-F12-T6, S5-F12-T8, S5-F12-T9
- Context: project-vault renderer/editor state, tree navigation, Chat Markdown renderer, backup/restore services.

### S5-F12-T6 — Add accessible backlinks, local graph, and whole-vault graph
...
- Blocked by: S5-F1-T2, S5-F12-T3, S5-F12-T4, S5-F12-T5
- Blocks: S5-F12-T9
- Context: root `ui-design.md`, shared Stage 5 primitives, project-vault navigation, candidate Cytoscape adapter.

### S5-F12-T7 — Extend explicit run context and approved agent note operations
...
- Blocked by: S5-F12-T1, S5-F12-T3, S5-F12-T4
- Blocks: S5-F12-T9
- Context: Stage 4 run-context manifests, MCP project-vault service, approval gate, harness launch paths.

### S5-F12-T8 — Extend portability, recovery, and security to graph vaults
...
- Scope: Matrix S5-KG; fresh/Stage 4 upgrade; central/project-owned; real Obsidian create/edit/link/rename/attachment/conflict; graph/list; agent context; export/import; Git status; restart; scale; docs/help; native packages.
- Out of scope: Unsupported Obsidian plugins, hosted sync, automatic release or repository commits.
- Acceptance: All S5-KG rows pass; no knowledge file is commit-eligible by default; no P0/P1 or acceptance blocker; supported syntax/limits and unsupported behavior are documented.
- Verification: Node 22 `npm run check`; strict OpenSpec; `npm run dev` plus `npm run dev:verify`; S5-F9 budgets; real Obsidian and package walkthroughs on promoted platforms; exact-SHA evidence crosswalk.
- Blocked by: S5-F12-T5, S5-F12-T6, S5-F12-T7, S5-F12-T8, S5-F9-T8, S5-F10-T8
- Blocks: S5-F11-T1
- Context: `docs/stage5-full-feature-test-matrix.md`, `docs/stage5-execution-plan.md`, project knowledge docs, root `ui-design.md`.
