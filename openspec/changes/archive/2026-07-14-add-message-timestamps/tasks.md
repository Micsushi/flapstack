...
- [x] 2.2 Manually verify today and older transcript messages.
...
2026-07-14 completion evidence: the unlocked exact Dev renderer displayed both
the current-day time-only form and the older date-plus-time form from the
bounded fixture. Persisted timestamps matched the mounted transcript state.
