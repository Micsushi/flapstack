...
- [x] 1.1 Extend the dev-control registry with bounded inspection and run tools.
- [x] 1.2 Implement authenticated loopback MCP startup, descriptor, and shutdown.
- [x] 1.3 Prove packaged builds remain disabled and unauthorized calls fail.

## 2. Real app control

- [x] 2.1 Expose compact environment, provider, chat, run, and transcript state.
- [x] 2.2 Expose redacted OpenCode diagnostics and pending approvals.
- [x] 2.3 Launch real OpenRouter/NanoGPT test runs through shared persistence.
- [x] 2.4 Reply to approvals, cancel runs, and wait for terminal state.
...
- [x] 3.1 Add registry, auth, lifecycle, redaction, and service tests.
