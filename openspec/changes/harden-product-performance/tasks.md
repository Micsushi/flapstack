...
### S5-F9-T1 — Define datasets, hardware classes, metrics, and budgets

- [ ] Completion: acceptance and verification passed
- Parent: Project Flapstack / Stage S5 / Feature S5-F9
...
- Blocked by: accepted Stage 4 exact SHA
- Blocks: S5-F9-T2, S5-F9-T3, S5-F9-T4, S5-F9-T5, S5-F9-T6, S5-F9-T7
- Context: current test fixtures, package profiles, docs/future-release-considerations.md.

### S5-F9-T2 — Build deterministic benchmark, trace, heap, and soak harnesses
...
- Blocked by: S5-F9-T1, S5-F9-T2
- Blocks: S5-F9-T8, S5-F10-T8
- Context: main/index startup, DB migration, App bootstrap, sidecars.

### S5-F9-T4 — Meet renderer responsiveness and long-history budgets
...
- Blocked by: S5-F1-T6, S5-F9-T1, S5-F9-T2
- Blocks: S5-F9-T8
- Context: transcript stores, activity timeline, usage explorer, Settings search.

### S5-F9-T5 — Meet database, search, migration, and history budgets
...
### S5-F9-T6 — Meet agent, terminal, workspace, and orchestration scale budgets
...
### S5-F9-T7 — Meet background-service and lifecycle resource budgets
...
- Blocked by: S5-F4-T8, S5-F8-T7, S5-F9-T1, S5-F9-T2
- Blocks: S5-F9-T8
- Context: app shutdown, automation, usage daemon, mobile bridge.

### S5-F9-T8 — Close performance and regression-gate acceptance

- [ ] Completion: acceptance and verification passed
- Parent: Project Flapstack / Stage S5 / Feature S5-F9
- Outcome: Required budgets pass on documented hardware/platforms and bounded gates prevent silent regression.
- Scope: Matrix S5-PF; consolidated report; CI/local subset; long soak; package; support limits; variance; documentation; approved exceptions.
...
- Blocked by: S5-F9-T2, S5-F9-T3, S5-F9-T4, S5-F9-T5, S5-F9-T6, S5-F9-T7
- Blocks: S5-F10-T8, S5-F11-T6, S5-F12-T9
- Context: docs/stage5-full-feature-test-matrix.md and performance reports.
