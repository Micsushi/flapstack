...
- Remaining acceptance: The installed Codex binary is `0.144.2` while the direct adapter intentionally pins `0.144.1`; the real supported-binary lifecycle, credentialed provider walkthrough, and packaged-path smoke therefore remain open and fail closed. No provider, live UI, or package evidence is inferred.
