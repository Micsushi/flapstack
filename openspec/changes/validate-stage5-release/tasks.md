# S5-F11 — Integrated Stage 5 Release

### S5-F11-T1 — Freeze candidate and reconcile every board/matrix row

- [ ] Completion: acceptance and verification passed
- Parent: Project Flapstack / Stage S5 / Feature S5-F11
- Outcome: One exact candidate ledger maps all F1-F10/F12 tasks and Stage 5 matrix rows to current evidence or explicit blocker.
...
### S5-F11-T2 — Prove clean install and Stage 4 upgrade/rollback

- [ ] Completion: acceptance and verification passed
- Parent: Project Flapstack / Stage S5 / Feature S5-F11
- Outcome: Fresh users and Stage 4 users reach Stage 5 without data, authority, history, or preference loss.
- Scope: Clean profiles; Stage 4 final DB/config/files; all migrations; onboarding; preserve-current visibility; inline personality; devices/artifacts/workspaces; interrupted migration; backup/rollback/reopen.
...
- Blocked by: S5-F2-T8, S5-F10-T8, S5-F11-T1
- Blocks: S5-F11-T3, S5-F11-T8
- Context: migration chain, onboarding, portability, package installers.

### S5-F11-T3 — Run one complete Stage 5 project workflow

- [ ] Completion: acceptance and verification passed
- Parent: Project Flapstack / Stage S5 / Feature S5-F11
- Outcome: One realistic project uses every Stage 5 user-facing capability together with matching state and recovery.
...
### S5-F11-T4 — Complete independent security and privacy review
...
- Blocked by: S5-F4-T8, S5-F5-T8, S5-F7-T7, S5-F8-T7, S5-F10-T6, S5-F10-T8, S5-F11-T1, S5-F11-T3
- Blocks: S5-F11-T8
- Context: all Stage 5 threat models and audit services.

### S5-F11-T5 — Complete UI, accessibility, and usability acceptance
...
### S5-F11-T6 — Complete performance, platform, package, and soak gates
...
### S5-F11-T7 — Reconcile product, installation, support, and recovery documentation
...
- Blocked by: S5-F10-T7, S5-F10-T8, S5-F11-T1
- Blocks: S5-F11-T8
- Context: README, ui-design.md, OpenSpec, Stage 5 docs.

### S5-F11-T8 — Run review/fix rounds and record release decision
...
- Blocked by: S5-F11-T2, S5-F11-T3, S5-F11-T4, S5-F11-T5, S5-F11-T6, S5-F11-T7
- Blocks: Stage S5 exit
- Context: candidate ledger, defect log, docs/stage5-full-feature-test-matrix.md.
