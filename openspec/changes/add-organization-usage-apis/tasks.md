# S5-F8 — Organization Usage APIs

### S5-F8-T1 — Lock provider scope, credentials, identity, and provenance

- [ ] Completion: acceptance and verification passed
- Parent: Project Flapstack / Stage S5 / Feature S5-F8
...
- Blocks: S5-F8-T2, S5-F8-T3, S5-F8-T4, S5-F8-T5, S5-F8-T6
- Context: existing optional organization fields, usage provenance, credential service.

### S5-F8-T2 — Implement OpenAI organization usage and cost adapter
...
- Blocked by: S5-F8-T1
- Blocks: S5-F8-T4, S5-F8-T5, S5-F8-T6, S5-F8-T7
- Context: usage provider registry, safe credentials, daemon polling.

### S5-F8-T3 — Implement Anthropic organization usage and cost adapter
...
### S5-F8-T4 — Add organization identities, samples, rollups, and reconciliation
...
- Blocked by: S5-F8-T1, S5-F8-T2, S5-F8-T3
- Blocks: S5-F8-T5, S5-F8-T6, S5-F8-T7
- Context: advanced usage samples/rollups/attribution.

### S5-F8-T5 — Add organization Settings, dashboard, budgets, and alerts
...
- Blocked by: S5-F1-T5, S5-F8-T2, S5-F8-T3, S5-F8-T4
- Blocks: S5-F8-T6, S5-F8-T7
- Context: usage explorer, settings, alerts, onboarding visibility registry.

### S5-F8-T6 — Harden daemon lifecycle, failures, security, and diagnostics
...
- Blocked by: S5-F8-T1, S5-F8-T2, S5-F8-T3, S5-F8-T4, S5-F8-T5
- Blocks: S5-F8-T7
- Context: usage daemon lifecycle, LaunchAgent/service paths.

### S5-F8-T7 — Close organization usage acceptance
...
- Scope: Matrix S5-OU; migrations; credentials; live providers; closed app; rate/failure; export; accessibility; package/platform; docs.
...
- Blocked by: S5-F8-T2, S5-F8-T3, S5-F8-T4, S5-F8-T5, S5-F8-T6
- Blocks: S5-F11-T3, S5-F11-T4, S5-F11-T6
