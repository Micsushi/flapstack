# S5-F2 — Guided Onboarding and Feature Visibility

### S5-F2-T1 — Lock questionnaire, presets, and always-visible core

- [ ] Completion: acceptance and verification passed
- Parent: Project Flapstack / Stage S5 / Feature S5-F2
...
- Blocked by: fully accepted Stage 4 feature list
- Blocks: S5-F2-T2, S5-F2-T4, S5-F2-T5
- Context: Stage 1-4 feature routers, Settings registry, future considerations.

### S5-F2-T2 — Build the authoritative feature visibility registry
...
- Blocked by: S5-F2-T1
- Blocks: S5-F2-T3, S5-F2-T5, S5-F2-T6
- Context: settings visibility/search, sidebar routes, Stage 4 feature registry.

### S5-F2-T3 — Persist visibility and migrate existing users safely
...
- Blocked by: S5-F2-T2
- Blocks: S5-F2-T4, S5-F2-T6, S5-F2-T8
- Context: settings persistence, portability registry, product invalidation.

### S5-F2-T4 — Build the first-run tutorial and questionnaire flow
...
- Blocked by: S5-F1-T2, S5-F1-T3, S5-F2-T1, S5-F2-T3
- Blocks: S5-F2-T7, S5-F2-T8
- Context: existing onboarding router, project selection, provider setup.

### S5-F2-T5 — Create reusable feature explanations and contextual help
...
- Blocked by: S5-F1-T2, S5-F2-T1, S5-F2-T2
- Blocks: S5-F2-T6, S5-F2-T8
- Context: feature registry, Settings search, tooltip/popover primitives.

### S5-F2-T6 — Add Settings visibility controls and rerunnable setup
...
- Blocked by: S5-F1-T5, S5-F2-T2, S5-F2-T3, S5-F2-T5
- Blocks: S5-F2-T7, S5-F2-T8
- Context: alphabetical Settings IA, settings persistence, route visibility.

### S5-F2-T7 — Prove hidden-feature operation and safe discovery
...
- Blocked by: S5-F2-T4, S5-F2-T6
- Blocks: S5-F2-T8
- Context: feature registry, app-control MCP, automation, usage daemon.

### S5-F2-T8 — Close onboarding and visibility acceptance

- [ ] Completion: acceptance and verification passed
- Parent: Project Flapstack / Stage S5 / Feature S5-F2
- Outcome: Fresh, upgraded, focused, standard, complete, skipped, and rerun paths pass on one exact SHA.
- Scope: Matrix S5-ON; migrations; accessibility; explanations; hidden operations; Settings; restart/multi-window; docs; package walkthrough.
...
- Blocked by: S5-F2-T3, S5-F2-T4, S5-F2-T5, S5-F2-T6, S5-F2-T7
- Blocks: S5-F11-T2, S5-F11-T5
