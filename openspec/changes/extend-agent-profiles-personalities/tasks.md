# S5-F3 — Agent Profiles and Reusable Personalities

### S5-F3-T1 — Lock vocabulary, boundaries, and S4 migration behavior

- [ ] Completion: acceptance and verification passed
- Parent: Project Flapstack / Stage S5 / Feature S5-F3
...
- Blocks: S5-F3-T2, S5-F3-T3, S5-F3-T4, S5-F3-T5, S5-F3-T6, S5-F3-T7, S5-F3-T8
- Context: S4 agent profile schema/migration/docs, extension trust, runtime capabilities.

### S5-F3-T2 — Add versioned Markdown personality contracts and storage
...
### S5-F3-T3 — Resolve personality references and migrate embedded presentation
...
- Blocked by: S5-F3-T1, S5-F3-T2
- Blocks: S5-F3-T4, S5-F3-T5, S5-F3-T6, S5-F3-T8
- Context: agent_profile_versions, presentation_json, resolver, snapshot service.

### S5-F3-T4 — Extend Profile Studio with a reusable Personality Library
...
- Blocked by: S5-F1-T2, S5-F1-T5, S5-F3-T2, S5-F3-T3
- Blocks: S5-F3-T5, S5-F3-T8, S5-F3-T9
- Context: Profile Studio, Markdown editor, settings search, portability.

### S5-F3-T5 — Add Agent Profile selection to every new-chat flow
...
- Blocked by: S5-F1-T4, S5-F3-T3, S5-F3-T4
- Blocks: S5-F3-T9, S5-F11-T3
- Context: new-chat form, Agent Runtime resolver, copy-on-create permissions.

### S5-F3-T6 — Add exact profile selection to sub-agent and workflow creation
...
- Blocked by: S5-F3-T1, S5-F3-T3, accepted S4-F3/F12
- Blocks: S5-F3-T9, S5-F11-T3
- Context: profile workflow materializer, spawned-agent service, orchestration definitions.

### S5-F3-T7 — Add provider-supported speed preference independent of effort
...
- Blocked by: S5-F3-T1, accepted S4-F11
- Blocks: S5-F3-T8, S5-F3-T9
- Context: model-run-controls, runtime compatibility, agent capability schema.

### S5-F3-T8 — Extend starter profiles, trust, portability, and evaluation
...
- Blocked by: S5-F3-T2, S5-F3-T3, S5-F3-T7
- Blocks: S5-F3-T9
- Context: starter catalog, evaluation runner, portability trust.

### S5-F3-T9 — Close profile and personality acceptance

- [ ] Completion: acceptance and verification passed
- Parent: Project Flapstack / Stage S5 / Feature S5-F3
- Outcome: Custom, starter, new-chat, direct child, and workflow agents reuse exact personality/profile snapshots safely.
- Scope: Matrix S5-AP; migration/rollback; Studio; new chat; child/workflow; speed/effort; import/export; restart; accessibility; package and provider evidence.
...
- Blocked by: S5-F3-T4, S5-F3-T5, S5-F3-T6, S5-F3-T7, S5-F3-T8
- Blocks: S5-F11-T3, S5-F11-T5
