...
- Add a first-class reasoning/activity event pipeline that preserves provider
  provenance, ordering, section boundaries, and honest visibility labels.
...
- Affected code: Stage 3 orchestration service/DTOs, engine adapters and workflow
  runtime, reasoning/activity contracts, task card, fleet/workspace views,
