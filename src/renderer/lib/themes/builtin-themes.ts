...
/**
 * Flapstack Dark - Default dark theme matching the app's original design
 * Uses the brand blue (#0034FF) as primary/accent color
 */
const FLAPSTACK_DARK: VSCodeFullTheme = {
  id: "flapstack-dark",
  name: "Flapstack Dark",
  type: "dark",
  source: "builtin",
...
/**
 * Flapstack Light - Default light theme matching the app's original design
 * Uses the brand blue (#0034FF) as primary/accent color
 */
const FLAPSTACK_LIGHT: VSCodeFullTheme = {
  id: "flapstack-light",
  name: "Flapstack Light",
  type: "light",
  source: "builtin",
  colors: {
...
export const BUILTIN_THEMES: VSCodeFullTheme[] = [
  // Flapstack default themes (first)
  FLAPSTACK_DARK,
  FLAPSTACK_LIGHT,
  // Cursor themes
  CURSOR_DARK,
 ...
 */
export const DEFAULT_LIGHT_THEME_ID = "flapstack-light"
export const DEFAULT_DARK_THEME_ID = "flapstack-dark"
