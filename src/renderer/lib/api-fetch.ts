 ...
 * Hosted API requests are disabled in Flapstack.
 */
 ...
 * Returns an empty string when no hosted backend is configured.
 */
...
export async function apiFetch(
  ...
  if (!baseUrl) {
    throw new Error("Hosted API is disabled in Flapstack")
  }
