...
// Preferences - Reasoning output
// Keep the existing storage key so current user preferences survive the rename.
...
export const systemLightThemeIdAtom = atomWithStorage<string>(
  ...
  "flapstack-light", // Default light theme
  undefined,
  { getOnInit: true },
)
...
export const systemDarkThemeIdAtom = atomWithStorage<string>(
  ...
  "flapstack-dark", // Default dark theme
  undefined,
  { getOnInit: true },
)
...
// This is used to show the onboarding screen after flapstack.dev sign-in
// Reset on logout
