...
export const AgentBashTool = memo(function AgentBashTool({
  ...
  return (
    ...
    >
          ...
          <div className="w-6 h-6 flex items-center justify-center">
            {isPending ? (
              ...
              <button
                type="button"
                aria-label={
                  isOutputExpanded ? "Collapse command details" : "Expand command details"
                }
      ...
      {(isPending || isOutputExpanded) && (
        <div data-command-details className="border-t border-border px-2.5 py-1.5">
