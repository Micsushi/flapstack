...
export function getDisplayPath(filePath: string, projectPath?: string): string {
  ...
  // Handle worktree paths: /.flapstack/worktrees/{chatId}/{subChatId}/relativePath
  const worktreeMatch = filePath.match(/\.flapstack\/worktrees\/[^/]+\/[^/]+\/(.+)$/)
  if (worktreeMatch) {
...
export type McpToolCategory =
  "search" | "list" | "get" | "create" | "update" | "delete" | "send" | "generate" | "other"
