...
2. Create the file .flapstack/worktree.json with setup commands
...
Example output for .flapstack/worktree.json:
{
  "setup-worktree": [
    "bun install",
...
Now analyze this project and create .flapstack/worktree.json with the appropriate setup commands.`,
}
