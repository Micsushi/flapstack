...
export const SETTINGS_CONTROL_REGISTRY: readonly SettingsControlMetadata[] = [
  ...
  control(
    ...
    "preferences",
    "Chat title detail",
    "Choose concise, balanced, or descriptive automatic titles",
    ["short", "length", "words", "descriptive", "concise"],
  ),
  control(
    "preferences-chat-auto-tags",
    "preferences",
    "Automatic chat tags",
    "Add short user tags and separate agent-only role labels when the first message is clear",
    [
      "bug",
      "manual",
      "coordinator",
  ...
  control(
    "preferences-chat-tag-confidence",
    "preferences",
    "Automatic tag confidence",
    "Set how certain automatic classification must be before assigning a tag or agent label",
    ["threshold", "percent", "certainty", "95"],
  ),
  control(
