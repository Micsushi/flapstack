          ...
          <TooltipTrigger asChild>
            <DropdownMenuTrigger asChild>
              ...
              >
                ...
                <span className="truncate max-w-[120px]">{currentBranch || "No branch"}</span>
                <HiChevronDown
                  className={cn("size-3 shrink-0 opacity-50", isCompact && "size-2.5")}
                />
              </Button>
            </DropdownMenuTrigger>
          </TooltipTrigger>
        ...
        <DropdownMenuContent align="start" className="w-48">
          {branches.map((branchInfo) => (
            <DropdownMenuItem
              ...
              className={cn("text-xs", branchInfo.branch === currentBranch && "bg-accent")}
            >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                ...
                {!isCompact && (
                  <span className="text-[10px] text-muted-foreground font-mono">#{pr.number}</span>
                )}
              </a>
            </TooltipTrigger>
