export const FLAPSTACK_MCP_INSTRUCTIONS = [
  ...
  "When the user explicitly asks this chat to wait for other chats, use wait_for_chats and then stop the turn. Flapstack will monitor durable queued and running work and resume this same chat without cross-chat completion messages.",
