...
export const futureStageCapabilities: FutureStageCapability[] = [
  {
    ...
    status: "scaffolded",
    gate: "Speech architecture decisions",
    summary: "STT/TTS adapter contracts, settings, and spoken summary fallback.",
  ...
  },
  {
    ...
    status: "scaffolded",
    gate: "App-owned loop scope and tool permissions",
    summary: "Provider registry and app-owned loop capability contract.",
  ...
  },
  {
    ...
    status: "scaffolded",
    gate: "Provider usage fields and cost table policy",
    summary: "Run usage normalization and rollup contract.",
