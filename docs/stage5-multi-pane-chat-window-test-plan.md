# Stage 5 Multi-Pane Chat and Window Test Plan

This document is the manual acceptance walkthrough for S5-F6. Task status
remains authoritative in
`openspec/changes/add-terminal-grid-swarm-workspaces/tasks.md`; integrated
acceptance remains authoritative in `docs/stage5-full-feature-test-matrix.md`.
...
- Strict S5-F6 OpenSpec validation passes.
...
## A. Group Layout and Full Chat Independence — S5-TG01/TG02
...
- Draft, IME, focus, scroll anchor, approval, error, and run state never cross
  Chat boundaries.
- Typing remains within the declared Stage 5 input-latency budget.
...
## B. Drag and Command Parity — S5-TG02/TG03
...
## D. Cross-Window Ownership and Recovery — S5-TG03
...
## E. Persistence, Migration, and Responsive Recovery — S5-TG05
...
## F. Advanced Pane and Swarm Truth — S5-TG06/TG07
...
## G. Accessibility, Performance, and Cleanup — S5-TG07
...
S5-F6 closes only when:

- S5-F6-T1 through S5-F6-T10 are checked from current evidence.
- S5-TG01 through S5-TG07 pass on one exact candidate.
